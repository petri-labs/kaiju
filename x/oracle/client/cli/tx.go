...
# Aggregate Prevote
$ kaijud tx oracle aggregate-prevote 1234 akaiju:1.234,ufusd:0.99

where "akaiju,ufusd" is the denominating currencies, and "1.234,0.99" is the exchange rates of these currencies in $uUSD from the voter's point of view.

If voting from a voting delegate, set "validator" to the address of the validator to vote on behalf of:
$ kaijud tx oracle aggregate-prevote 1234 akaiju:1.234,ufusd:0.99 mervaloper1...
`),
...
$ kaijud tx oracle aggregate-vote 1234 akaiju:1.234,ufusd:0.99
...
If voting from a voting delegate, set "validator" to the address of the validator to vote on behalf of:
$ kaijud tx oracle aggregate-vote 1234 akaiju:1.234,ufusd:0.99 mervaloper1...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
$ kaijud tx oracle set-feeder mer1...
