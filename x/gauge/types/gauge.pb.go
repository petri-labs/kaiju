...
// source: kaiju/gauge/v1/gauge.proto
...
func init() {
	proto.RegisterType((*Checkpoint)(nil), "kaiju.gauge.v1.Checkpoint")
	proto.RegisterType((*Reward)(nil), "kaiju.gauge.v1.Reward")
	proto.RegisterType((*UserReward)(nil), "kaiju.gauge.v1.UserReward")
}

func init() { proto.RegisterFile("kaiju/gauge/v1/gauge.proto", fileDescriptor_978538bfbd181b7d) }
