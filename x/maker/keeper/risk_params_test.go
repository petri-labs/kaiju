...
func (suite *KeeperTestSuite) dummyCollateralRiskParams() (crp, crp2 types.CollateralRiskParams) {
	...
	catalyticKaijuRatio := sdk.NewDecWithPrec(5, 2)
	...
	crp = types.CollateralRiskParams{
		...
		CatalyticKaijuRatio:   &catalyticKaijuRatio,
	...
	catalyticKaijuRatio2 := sdk.NewDecWithPrec(6, 2)
	...
	crp2 = types.CollateralRiskParams{
		...
		CatalyticKaijuRatio:   &catalyticKaijuRatio2,
