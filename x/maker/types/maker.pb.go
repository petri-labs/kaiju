...
// source: kaiju/maker/v1/maker.proto
...
type CollateralRiskParams struct {
	...
	// catalytic ratio of collateralized Kaiju to asset, to maximize the LTV
	// in [basic-LTV, LTV]
	CatalyticKaijuRatio *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,8,opt,name=catalytic_kaiju_ratio,json=catalyticKaijuRatio,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"catalytic_kaiju_ratio,omitempty"`
...
type TotalBacking struct {
	...
	// total burned kaiju; negative value means minted kaiju
	KaijuBurned types.Coin `protobuf:"bytes,3,opt,name=kaiju_burned,json=kaijuBurned,proto3" json:"kaiju_burned"`
}
...
func (m *TotalBacking) GetKaijuBurned() types.Coin {
	if m != nil {
		return m.KaijuBurned
	}
	return types.Coin{}
}
...
func (m *PoolBacking) GetKaijuBurned() types.Coin {
	if m != nil {
		return m.KaijuBurned
	}
	return types.Coin{}
...
type TotalCollateral struct {
	...
	// total collateralized kaiju
	KaijuCollateralized types.Coin `protobuf:"bytes,2,opt,name=kaiju_collateralized,json=kaijuCollateralized,proto3" json:"kaiju_collateralized"`
}
...
func (m *TotalCollateral) GetKaijuCollateralized() types.Coin {
	if m != nil {
		return m.KaijuCollateralized
	}
	return types.Coin{}
}
...
type PoolCollateral struct {
	...
	// total collateralized kaiju
	KaijuCollateralized types.Coin `protobuf:"bytes,3,opt,name=kaiju_collateralized,json=kaijuCollateralized,proto3" json:"kaiju_collateralized"`
}
...
func (m *PoolCollateral) GetKaijuCollateralized() types.Coin {
	if m != nil {
		return m.KaijuCollateralized
	}
	return types.Coin{}
...
type AccountCollateral struct {
	...
	// total collateralized kaiju
	KaijuCollateralized types.Coin `protobuf:"bytes,4,opt,name=kaiju_collateralized,json=kaijuCollateralized,proto3" json:"kaiju_collateralized"`
...
func (m *AccountCollateral) GetKaijuCollateralized() types.Coin {
	if m != nil {
		return m.KaijuCollateralized
	}
	return types.Coin{}
...
func init() {
	proto.RegisterType((*BackingRiskParams)(nil), "kaiju.maker.v1.BackingRiskParams")
	proto.RegisterType((*CollateralRiskParams)(nil), "kaiju.maker.v1.CollateralRiskParams")
	proto.RegisterType((*RegisterBackingProposal)(nil), "kaiju.maker.v1.RegisterBackingProposal")
	proto.RegisterType((*RegisterCollateralProposal)(nil), "kaiju.maker.v1.RegisterCollateralProposal")
	proto.RegisterType((*SetBackingRiskParamsProposal)(nil), "kaiju.maker.v1.SetBackingRiskParamsProposal")
	proto.RegisterType((*SetCollateralRiskParamsProposal)(nil), "kaiju.maker.v1.SetCollateralRiskParamsProposal")
	proto.RegisterType((*BatchBackingRiskParams)(nil), "kaiju.maker.v1.BatchBackingRiskParams")
	proto.RegisterType((*BatchSetBackingRiskParamsProposal)(nil), "kaiju.maker.v1.BatchSetBackingRiskParamsProposal")
	proto.RegisterType((*BatchCollateralRiskParams)(nil), "kaiju.maker.v1.BatchCollateralRiskParams")
	proto.RegisterType((*BatchSetCollateralRiskParamsProposal)(nil), "kaiju.maker.v1.BatchSetCollateralRiskParamsProposal")
	proto.RegisterType((*TotalBacking)(nil), "kaiju.maker.v1.TotalBacking")
	proto.RegisterType((*PoolBacking)(nil), "kaiju.maker.v1.PoolBacking")
	proto.RegisterType((*AccountBacking)(nil), "kaiju.maker.v1.AccountBacking")
	proto.RegisterType((*TotalCollateral)(nil), "kaiju.maker.v1.TotalCollateral")
	proto.RegisterType((*PoolCollateral)(nil), "kaiju.maker.v1.PoolCollateral")
	proto.RegisterType((*AccountCollateral)(nil), "kaiju.maker.v1.AccountCollateral")
}

func init() { proto.RegisterFile("kaiju/maker/v1/maker.proto", fileDescriptor_ee82e911d469b50f) }
...
func (m *CollateralRiskParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CatalyticKaijuRatio != nil {
		{
			size := m.CatalyticKaijuRatio.Size()
			i -= size
			if _, err := m.CatalyticKaijuRatio.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintMaker(dAtA, i, uint64(size))
		}
...
func (m *TotalBacking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.KaijuBurned.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TotalCollateral) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.KaijuCollateralized.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CollateralRiskParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CatalyticKaijuRatio", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v github_com_cosmos_cosmos_sdk_types.Dec
			m.CatalyticKaijuRatio = &v
			if err := m.CatalyticKaijuRatio.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
...
func (m *TotalBacking) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KaijuBurned", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.KaijuBurned.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TotalCollateral) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KaijuCollateralized", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.KaijuCollateralized.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
