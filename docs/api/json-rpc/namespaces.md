...
Check the JSON-RPC namespaces supported on Blackfury. {synopsis}
...
|--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|--------------------|
| [`eth`](./endpoints.md#eth-methods)           | Blackfury provides several extensions to the standard `eth` JSON-RPC namespace.                                                                                                                                                | ✔         | ✔                  |
