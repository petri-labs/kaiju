...
export interface QueryHrpIbcRecordResponse {
  hrpIbcRecord: HrpIbcRecord | undefined;
}
...
export const QueryHrpIbcRecordsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryHrpIbcRecordsResponse>, I>>(object: I): QueryHrpIbcRecordsResponse {
    const message = createBaseQueryHrpIbcRecordsResponse();
...
export const QueryHrpIbcRecordRequest = {
  ...
  fromJSON(object: any): QueryHrpIbcRecordRequest {
    return { hrp: isSet(object.hrp) ? String(object.hrp) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryHrpIbcRecordRequest>, I>>(object: I): QueryHrpIbcRecordRequest {
    const message = createBaseQueryHrpIbcRecordRequest();
...
export const QueryHrpIbcRecordResponse = {
  ...
  fromJSON(object: any): QueryHrpIbcRecordResponse {
    return { hrpIbcRecord: isSet(object.hrpIbcRecord) ? HrpIbcRecord.fromJSON(object.hrpIbcRecord) : undefined };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryHrpIbcRecordResponse>, I>>(object: I): QueryHrpIbcRecordResponse {
    const message = createBaseQueryHrpIbcRecordResponse();
    message.hrpIbcRecord = (object.hrpIbcRecord !== undefined && object.hrpIbcRecord !== null)
...
export const QueryNativeHrpResponse = {
  ...
  fromJSON(object: any): QueryNativeHrpResponse {
    return { nativeHrp: isSet(object.nativeHrp) ? String(object.nativeHrp) : "" };
  },
