...
function createBaseMsgConfirmLogicCall(): MsgConfirmLogicCall {
  return { invalidationId: "", invalidationNonce: 0, ethSigner: "", orchestrator: "", signature: "" };
}
...
function createBaseMsgExecuteIbcAutoForwards(): MsgExecuteIbcAutoForwards {
  return { forwardsToClear: 0, executor: "" };
}
...
function createBaseMsgLogicCallExecutedClaim(): MsgLogicCallExecutedClaim {
  return { eventNonce: 0, blockHeight: 0, invalidationId: new Uint8Array(), invalidationNonce: 0, orchestrator: "" };
}
