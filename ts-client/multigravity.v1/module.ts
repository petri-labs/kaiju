...
export { MsgRequestBatch, MsgValsetConfirm, MsgLogicCallExecutedClaim, MsgBatchSendToEthClaim, MsgConfirmBatch, MsgSendToEth, MsgConfirmLogicCall, MsgERC20DeployedClaim, MsgCancelSendToEth, MsgValsetUpdatedClaim, MsgSubmitBadSignatureEvidence, MsgSendToCosmosClaim };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgRequestBatch({ value }: msgRequestBatchParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgRequestBatch", value: MsgRequestBatch.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgValsetConfirm({ value }: msgValsetConfirmParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgValsetConfirm", value: MsgValsetConfirm.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgLogicCallExecutedClaim({ value }: msgLogicCallExecutedClaimParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgLogicCallExecutedClaim", value: MsgLogicCallExecutedClaim.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgBatchSendToEthClaim({ value }: msgBatchSendToEthClaimParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgBatchSendToEthClaim", value: MsgBatchSendToEthClaim.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgConfirmBatch({ value }: msgConfirmBatchParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgConfirmBatch", value: MsgConfirmBatch.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgSendToEth({ value }: msgSendToEthParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgSendToEth", value: MsgSendToEth.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgConfirmLogicCall({ value }: msgConfirmLogicCallParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgConfirmLogicCall", value: MsgConfirmLogicCall.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgERC20DeployedClaim({ value }: msgERC20DeployedClaimParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgERC20DeployedClaim", value: MsgERC20DeployedClaim.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCancelSendToEth({ value }: msgCancelSendToEthParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgCancelSendToEth", value: MsgCancelSendToEth.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgValsetUpdatedClaim({ value }: msgValsetUpdatedClaimParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgValsetUpdatedClaim", value: MsgValsetUpdatedClaim.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgSubmitBadSignatureEvidence({ value }: msgSubmitBadSignatureEvidenceParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgSubmitBadSignatureEvidence", value: MsgSubmitBadSignatureEvidence.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgSendToCosmosClaim({ value }: msgSendToCosmosClaimParams): EncodeObject {
			try {
				return { typeUrl: "/multigravity.v1.MsgSendToCosmosClaim", value: MsgSendToCosmosClaim.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			MultigravityV1: new SDKModule(test)
		},
		registry: msgTypes
  }
}
