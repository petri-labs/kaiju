...
import { Module as Bech32IbcBech32IbcV1Beta1, msgTypes as Bech32IbcBech32IbcV1Beta1MsgTypes } from './bech32ibc.bech32ibc.v1beta1'
...
import { Module as GravityV1, msgTypes as GravityV1MsgTypes } from './gravity.v1'
...
import { Module as MultigravityV1, msgTypes as MultigravityV1MsgTypes } from './multigravity.v1'


const Client = IgniteClient.plugin([
    Bech32IbcBech32IbcV1Beta1, CosmosAuthV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1Beta1, CosmosNftV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, EthermintEvmV1, EthermintFeemarketV1, GravityV1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, MultigravityV1
]);

const registry = new Registry([
  ...Bech32IbcBech32IbcV1Beta1MsgTypes,
